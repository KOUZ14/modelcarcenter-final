...
export default function Page() {
  return <main><SiteHeader/><article className="inner-page shell legal-page" id="main-content" tabIndex={-1}>
    ...
    <h2>Placement and availability</h2><p>Placements match a collector&apos;s search and filters, appear on the first marketplace results page, and rotate between stores. A listing shown as sponsored is not repeated in the regular results on that page. No minimum views, clicks, sales, or particular position is guaranteed.</p><p>Your store must remain active and accept current seller terms. Your listing must remain active, in stock, have available units and a primary photo. Unavailable listings are suppressed and can reappear during the remaining campaign period when eligible again.</p>
