...
export default function SellerTermsPage() {
  return <PolicyPage title="Seller Terms" intro="These Seller Terms apply to professional stores and individual collectors who apply, create listings, or sell through Model Car Center.">
    ...
    <p><b>Payment processing is charged separately and is not part of the marketplace fee percentages above.</b> Under the current Stripe separate-charges-and-transfers setup, Model Car Center pays Stripe processing fees and retains seller proceeds on the platform during the delivery review window. Completed order records distinguish the marketplace fee, actual Stripe processing cost when available, seller proceeds, and transfer status. There are no listing fees, monthly seller fees, marketplace subscription fees, or account-opening fees for V1.</p>
