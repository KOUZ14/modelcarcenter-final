...
export default function PrivacyPage() {
  return <PolicyPage effectiveDate="September 18, 2026" title="Privacy Policy" intro="This Policy explains the personal information Model Car Center collects, why we use it, when we disclose it, and the choices available to you.">
    ...
    <p>With your optional usage-measurement choice, we collect task names, completion or error status, counts and elapsed time to improve shopping and seller setup. We exclude private form contents, search text, addresses, messages and payment information. We do not attach account identities to these events. An opaque completion marker prevents a confirmed purchase from being counted twice. Records expire after 90 days. Change this choice in Cookie settings; Global Privacy Control and Do Not Track keep measurement off.</p>
    ...
    <p>We use strictly necessary authentication and security cookies. For guests, local storage keeps cart and wishlist choices on that device. Session storage remembers shipping ZIP, delivery-address drafts, and checkout progress in the current tab; local storage also remembers notice and help preferences. Optional usage measurement uses a consent cookie only after you allow it. We do not use advertising tracking cookies. Global Privacy Control and Do Not Track disable optional usage measurement. Learn more in our <Link href="/cookies">Cookie &amp; Local Storage Policy</Link>.</p>
