...
export function SiteFooter() {
  return <footer><div className="shell footer-top"><Link className="brand footer-brand" href="/"><span className="brand-mark">MCC</span><span className="brand-name">MODEL CAR <b>CENTER</b></span></Link><p>One search for the models worth collecting.</p></div><div className="shell footer-links">
    ...
    <div><h3>Support</h3><Link href="/resolution">Resolution Center</Link><Link href="/protection">Buyer &amp; seller protection</Link><Link href="/contact">Contact</Link><Link href="/shipping">Shipping</Link><Link href="/returns">Returns &amp; refunds</Link></div>
    <div><h3>Policies</h3><Link href="/terms">Marketplace terms</Link><Link href="/privacy">Privacy</Link><Link href="/cookies">Cookies &amp; local storage</Link><Link href="/admin">Admin</Link></div>
